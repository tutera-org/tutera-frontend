...
const Empowering = () => {
  ...
  return (
    <section className="w-full bg-[#FFFFFF] md:py-24 py-10">
      <div className="w-[90%] lg:max-w-[1240px] mx-auto">
        ...
        <p className="lg:w-[65%] mx-auto md:text-[1.25rem] text-[1rem] font-medium text-center md:mb-18 mb-8 text-[#4B4B4B]">Tutera is more than an LMS it’s where independent instructors, passionate learners, and creative professionals connect, grow, and succeed without limitations.</p>
